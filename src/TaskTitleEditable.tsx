...
function TaskTitleEditable(props: Props) {
    ...
    return (
        ...
        {editable ? (
          <>
          <TextField id="standard-basic" value={textInputValue} onChange={handleTextInputChange} variant="standard" />
          ...
          <>
          <ListItemText primary={props.title} sx={{mr: 10, ml: 1, bgcolor: 'background.paper', textDecoration: props.isDone ? 'line-through' : 'none' }} />
